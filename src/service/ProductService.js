            ...
            return [
                {
                    id: '1000',
                    code: 'f230fh0g3',
                    name: 'Which Python version is recommended now?',
                    description: 'Product Description',
                    image: 'bamboo-watch.jpg',
                    price: 65,
                    category: 'Which Python version is recommended now?',
                    quantity: 24,
                ...
                },
                {
                    ...
                    code: 'nvklal433',
                    name: 'Which Python version is recommended now?',
                    description: 'Which Python version is recommended now?',
                ...
                },
                {
                    id: '1002',
                    code: 'zz21cz3c1',
                    name: 'Which Python version is recommended now?Which Python version is recommended now?Which Python version is recommended now?Which Python version is recommended now?',
                    description: 'Which Python version is recommended now?',
                    image: 'blue-band.jpg',
                    price: 79,
                    category: 'Which Python version is recommended now?',
                ...
                },
                {
                    ...
                    code: '244wgerg2',
                    name: 'Blue T-Shirt',
                    description: 'Which Python version is recommended now?Which Python version is recommended now?Which Python version is recommended now?',
                    image: 'blue-t-shirt.jpg',
                    price: 29,
                    category: 'Which Python version is recommended now?Which Python version is recommended now?Which Python version is recommended now?',
                    quantity: 25,
                    inventoryStatus: 'INSTOCK',
                    rating: 5
                },
